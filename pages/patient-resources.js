...
import PatientResourcesLayout from "../components/Layouts/PatientResourcesLayout";
...
export default function HomePage({ page_info, events }) {
  return (
      <>
        ...
        <PatientResourcesLayout data={ PAGE_DATA } universal={UNIVERSAL_DATA} page_info={page_info}/>
        {/*{jsxPosts}*/}
      </>
  );
}
